...
const Navbar = () => {
    ...
    return (
        <header className='max-w-screen-2xl container mx-auto fixed top-0 left-0 right-0 transition-all duration-400 ease-in-out'>
            <div className={`navbar xl:px-24  ${isSticky ? "shadow-md bg-base-100 transition-all duration-400 ease-in-out " : "text-gray-950"}`}>
                ...
                <div className="navbar-end">
                    ...
                    {/* Cart Items */}
                    <div tabIndex={0} role="button" className="btn btn-ghost btn-circle mr-3 lg:flex hidden flex item-center justify-center">
